...
var pro=[{ "name": ""},{ "name": "北京"},{ "name": "天津"},{ "name": "河北"},{ "name": "山西"},{ "name": "内蒙古"},{ "name": "辽宁"},{ "name": "吉林"},{ "name": "黑龙江"},{ "name": "上海"},{ "name": "江苏"},{ "name": "浙江"},{ "name": "安徽"},{ "name": "福建"},{ "name": "江西"},{ "name": "山东"},{ "name": "河南"},{ "name": "湖北"},{ "name": "湖南"},{ "name": "广东"},{ "name": "广西"},{ "name": "海南"},{ "name": "重庆"},{ "name": "四川"},{ "name": "贵州"},{ "name": "云南"},{ "name": "西藏"},{ "name": "陕西"},{ "name": "甘肃"},{ "name": "青海"},{ "name": "宁夏"},{ "name": "新疆"}]

//创建国家下拉框
for(var i = 0; i < globalCountries.length; i++){
    $("#country").append('<option value="'+globalCountries[i].cn+'">'+globalCountries[i].cn+'</option>');
}

for(var j=0; j < pro.length; j++){
    $("#pro").append('<option value="'+pro[j].name+'">'+pro[j].name+'</option>');
}
$("#country").on('change',function(){
    ...
    $("#pro").html('');
    if(val == "中国"){
        $("#pro").prev('span').text("请选择");
        for(var j=0; j < pro.length; j++){
            $("#pro").append('<option value="'+pro[j].name+'">'+pro[j].name+'</option>');
        }
    }else{
        $("#pro").html('<option value="">其他</option>');
        $("#pro").prev('span').text("其他");
    }
});
