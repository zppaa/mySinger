var list=[
{"name":''},
        { "name": "北京", "city":[{"name":"东城区"},{"name":"西城区"},{"name":"朝阳区"},{"name":"丰台区"},{"name":"石景山区"},{"name":"海淀区"},{"name":"门头沟区"},{"name":"房山区"},{"name":"通州区"},{"name":"顺义区"},{"name":"昌平区"},{"name":"大兴区"},{"name":"平谷区"},{"name":"怀柔区"},{"name":"密云县"},{"name":"延庆县"}]},

        { "name": "天津", "city":[{"name":"和平区"},{"name":"河东区"},{"name":"河西区"},{"name":"南开区"},{"name":"河北区"},{"name":"红挢区"},{"name":"滨海新区"},{"name":"东丽区"},{"name":"西青区"},{"name":"津南区"},{"name":"北辰区"},{"name":"宁河区"},{"name":"武清区"},{"name":"静海县"},{"name":"宝坻区"},{"name":"蓟县"}]},
        ...
        { "name": "上海", "city":[
            ...
            {"name":"黄浦区"},{"name":"卢湾区"},{"name":"徐汇区"},{"name":"长宁区"},{"name":"静安区"},{"name":"普陀区"},{"name":"闸北区"},{"name":"虹口区"},{"name":"杨浦区"},{"name":"闵行区"},{"name":"宝山区"},{"name":"嘉定区"},{"name":"浦东新区"},{"name":"金山区"},{"name":"松江区"},{"name":"奉贤区"},{"name":"青浦区"},{"name":"崇明县"}
        ...
        { "name": "重庆", "city":[{"name":"万州区"},{"name":"涪陵区"},{"name":"渝中区"},{"name":"大渡口区"},{"name":"江北区"},{"name":"沙坪坝区"},{"name":"九龙坡区"},{"name":"南岸区"},{"name":"北碚区"},{"name":"万盛区"},{"name":"双挢区"},{"name":"渝北区"},{"name":"巴南区"},{"name":"长寿区"},{"name":"綦江县"},{"name":"潼南县"},{"name":"铜梁县"},{"name":"大足县"},{"name":"荣昌县"},{"name":"壁山县"},{"name":"梁平县"},{"name":"城口县"},{"name":"丰都县"},{"name":"垫江县"},{"name":"武隆县"},{"name":"忠县"},{"name":"开县"},{"name":"云阳县"},{"name":"奉节县"},{"name":"巫山县"},{"name":"巫溪县"},{"name":"黔江区"},{"name":"石柱土家族自治县"},{"name":"秀山土家族苗族自治县"},{"name":"酉阳土家族苗族自治县"},{"name":"彭水苗族土家族自治县"},{"name":"江津区"},{"name":"合川区"},{"name":"永川区"},{"name":"南川区"}]},
        ...
        { "name": "台湾", "city":[
            ...
            {"name":"台北市"},{"name":"高雄市"},{"name":"基隆市"},{"name":"台中市"},{"name":"台南市"},{"name":"新竹市"},{"name":"嘉义市"},{"name":"台北县"},{"name":"宜兰县"},{"name":"新竹县"},{"name":"桃园县"},{"name":"苗栗县"},{"name":"台中县"},{"name":"彰化县"},{"name":"南投县"},{"name":"嘉义县"},{"name":"云林县"},{"name":"台南县"},{"name":"高雄县"},{"name":"屏东县"},{"name":"台东县"},{"name":"花莲县"},{"name":"澎湖县"},
        ...
        { "name": "澳门", "city":[
            ...
            {"name":"花地玛堂区"},{"name":"圣安多尼堂区"},{"name":"大堂区"},{"name":"望德堂区"},{"name":"风顺堂区"},{"name":"嘉模堂区"},{"name":"圣方济各堂区"}

        ]},

        { "name": "香港", "city":[

            {"name":"中西区"},{"name":"东区"},{"name":"九龙城区"},{"name":"观塘区"},{"name":"南区"},{"name":"深水区"},{"name":"湾仔区"},{"name":"黄大仙区"},{"name":"油尖旺区"},{"name":"离岛区"},{"name":"葵青区"},{"name":"北区"},{"name":"西贡区"},{"name":"沙田区"},{"name":"屯门区"},{"name":"大埔区"},{"name":"荃湾区"},{"name":"元朗区"},{"name":"其他"}
...
function init(){
    ...
    for(var e in list){
        var opt_1=new Option(list[e].name,list[e].name);
        _province.add(opt_1);
    }
}
